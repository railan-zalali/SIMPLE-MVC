...
if (isset($_POST['simpan'])) {
    ...
    // perintah query untuk menampilkan nip dari tabel siswa berdasarkan nip dari hasil submit form
    ...
    // jika nip belum ada
        ...
        if(move_uploaded_file($tmp_file, $path)) {
            ...
            $insert = mysqli_query($db, "INSERT INTO tbl_guru(nip,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,agama,alamat,no_hp,foto)
                VALUES('$nip','$nama','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$agama','$alamat','$no_hp','$nama_file')")
