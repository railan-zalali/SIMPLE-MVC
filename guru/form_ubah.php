	...
	if (isset($_GET['nip'])) {
		...
		$nip = $_GET['nip'];
        // perintah query untuk menampilkan data dari tabel siswa berdasarkan nip
		$query = mysqli_query($db, "SELECT * FROM tbl_guru WHERE nip='$nip'") or die('Query Error : '.mysqli_error($db));
