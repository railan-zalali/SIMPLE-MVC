...
<body>
    <div class="container-fluid">
      <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        <h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-user title-icon fa-2x"></i> Data Siswa</h5>
        <a href="../logout.php" role="button" style="margin-right: 1%; margin-top: 1vh; color: #17a2b8;"><i title="Keluar" class="fas fa-user-circle fa-2x"></i></a>
        <a class="btn btn-info" href="../pilihan_menu.php" role="button"><i title="Kembali Ke Menu" class="fas fa-arrow-left"></i> Menu </a>
...
?>
        ...
        <!-- <div class="container-fluid">
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">&copy; 2020 - <a class="text-info" href="http://torolab.id/">@Railan321</a></div>
                </div>
            </footer>
        </div> -->
