...
<!--                             <a title="Ubah" class="btn btn-outline-info" href="?page=ubah&nis=<?php echo $data['nis']; ?>" data><i class="fas fa-edit"></i></a> -->
                            <button type="button" class="btn-outline-info" data-toogle="modal" data-target="#myModal" title="Ubah"></button>
